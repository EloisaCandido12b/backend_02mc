...
app.get("/", (request, response) => {
    ...
    const selectCommand = "SELECT name, email, age FROM eloisacandido_02mc"
...
app.post("/cadastrar", (request, response) => {
    ...
    const insertCommand = `
        INSERT INTO eloisacandido_02mc(name, email, age, password)
        VALUES (?, ?, ?, ?)
    `
...
app.post("/login", (request, response) => {
    ...
    const selectCommand = "SELECT * FROM eloisacandido_02mc WHERE email = ?"
